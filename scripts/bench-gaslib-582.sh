...
echo "bench: tag=$TAG map=$GAZFLOW_COMPRESSOR_MAP_MODE strict=$GAZFLOW_COMPRESSOR_STRICT_NEWTON envelopes=$GAZFLOW_SCENARIO_PRESSURE_ENVELOPES shortpipe_coupled=$GAZFLOW_SCENARIO_SHORTPIPE_COUPLED_ENVELOPES floor_anchor=$GAZFLOW_SCENARIO_PRESSURE_FLOOR_ANCHOR in_newton=$GAZFLOW_SCENARIO_PRESSURE_IN_NEWTON clamp=$GAZFLOW_SCENARIO_PRESSURE_CLAMP minimal_anchors=$GAZFLOW_TRANSPORT_MINIMAL_ANCHORS refine_passes=$GAZFLOW_MASS_BALANCE_REFINEMENT_PASSES"
echo "out: $OUT"
