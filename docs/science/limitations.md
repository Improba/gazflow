...
- GasLib-582 full convergence: enthalpic compressor in Newton or strict convergence without partial accept (v18 contract Q: ~2.0 m³/s; v19 head Jacobian opt-in: no floor improvement, July 2026).
